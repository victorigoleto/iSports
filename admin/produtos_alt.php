    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><strong><em>Alteração de Produtos</em></strong></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    <form id="form1" name="form1" method="post" action="produtos_alt_conf.php">
      <table width="100%" border="0" cellpadding="5">
        <tr>
          <td width="20%"><em><strong>Produto Ativo:</strong></em></td>
          <td><p>
            <label>
              <input name="rdbAtivo" type="radio" id="rdbAtivo_0" value="S" <?php if ($registro_rsProdutos['ativo_pro'] == "S") { ?> checked="checked" <?php } ?> />
              Sim</label>
            <br />
            <label>
              <input type="radio" name="rdbAtivo" value="N" id="rdbAtivo_1" <?php if ($registro_rsProdutos['ativo_pro'] == "N") { ?> checked="checked" <?php } ?> />
              Não</label>
            <br />
          </p></td>
        </tr>
        <tr>
          ...
          <td><label for="txtDescricao"></label>
            <textarea name="txtDescricao" id="txtDescricao" cols="45" rows="5"><?php echo $registro_rsProdutos ['descricao_pro'];?></textarea></td>
        </tr>
        <tr>
          <td><strong><em>Imagem do Produto:</em></strong></td>
          <td><label for="txtImagem"></label>
            <input name="txtImagem" type="text" id="txtImagem" size="40" value="<?php echo $registro_rsProdutos ['imagem_pro'];?>" /></td>
        </tr>
        <tr>
          <td><strong><em>Marcas:</em></strong></td>
          <td><label for="cmbMarcas"></label>
            <select name="cmbMarcas" id="cmbMarcas">
              <?php
do {  
?>
              <option value="<?php echo $row_recordMarcas['codigo_mar'];?>" <?php if ($row_recordMarcas['codigo_mar'] == $registro_rsProdutos['codigo_mar']) { ?> selected="selected" <?php } ?> ><?php echo $row_recordMarcas['nome_mar'];?></option>
              <?php
...
do {  
?>
              <option value="<?php echo $row_recordCategorias['codigo_cat'];?>" <?php if ($row_recordCategorias['codigo_cat']== $registro_rsProdutos['codigo_cat']) { ?> selected="selected" <?php } ?> ><?php echo $row_recordCategorias['nome_cat'];?></option>
              <?php
...
?>
        ...
        <tr>
          ...
          <td><input name="txtPrecoUnitario" type="text" id="txtPrecoUnitario" size="40" value="<?php echo $registro_rsProdutos ['preco_unitario_pro'];?>"/></td>
        </tr>
        <tr>
          <td><em><strong>Produto na Página Principal:</strong></em></td>
          <td><p>
            <label>
              <input type="radio" name="cdbPrincipal" value="S" id="cdbPrincipal_0" <?php if ($registro_rsProdutos['principal_pro'] == "S") { ?> checked="checked" <?php } ?> /> 
              Sim</label>
            <br />
            <label>
              <input type="radio" name="cdbPrincipal" value="N" id="cdbPrincipal_1" <?php if ($registro_rsProdutos['principal_pro'] == "N") { ?> checked="checked" <?php } ?> /> 
              Não</label>
            <br />
          </p></td>
        </tr>
        <tr>
          ...
          <td><input name="txtQuantidade" type="text" id="txtQuantidade" size="40" value="<?php echo $registro_rsProdutos ['qtde_estoque_pro'];?>"/></td>
        </tr>
        <tr>
          <td><strong><em>Resumo de Produtos:</em></strong></td>
          <td><textarea name="txtResumo" id="txtResumo" cols="45" rows="5"><?php echo $registro_rsProdutos ['resumo_pro'];?></textarea></td>
        </tr>
        <tr>
          <td align="center"><input type="submit" name="button" id="button" value="Alterar" /></td>
          <td width="50%" align="center"><input type="reset" name="button2" id="button2" value="Limpar" /> <input type="hidden" name="hidCodigo" id="hidCodigo" value="<?php echo $registro_rsProdutos ['codigo_pro']; ?>"/></td>
        </tr>
      </table>
    </form>
    <p>&nbsp;</p>
