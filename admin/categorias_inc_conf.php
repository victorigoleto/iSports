...
<?php
	//Leitura de Dados
	$nome_cat = $_POST['txtCategoria'];
	
	//Criação da Instrução SQL
	$sql = "INSERT INTO tabcategorias ".
		"(nome_cat)".
		"VALUES (".
		" ' " . $nome_cat. " ' ".
		" ) ";
...
<div id="divFundo">
  ...
  <div id="divBanner">
    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><strong><em>Confirmação de Inclusão de Categorias</em></strong></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    <table width="900" border="1">
      <tr>
        <td width="889" align="center"><em>Categoria incluída com sucesso !</em></td>
      </tr>
    </table>
    <p>&nbsp;</p>
  </div>
