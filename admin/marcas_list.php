    ...
    <div id="divTitulo2">
      <table width="90%" border="1" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><em><strong>Listagem de Marcas</strong></em></td>
        </tr>
      </table>
    </div>
<p>
      <?php if($total_rsMarcas > 0) { ?></p>
    <table width="900" border="1">
      <tr>
        <td colspan="3">&nbsp;</td>
        <td width="801" align="center"><strong><em>Listagem de Marcas</em></strong></td>
        <?php do { //inicio do Repate Region ?>
      </tr>
     
      <tr>
        <td width="35"><a href="marcas_alt.php?codigo_mar=<?php echo $registro_rsMarcas ['codigo_mar']; ?>"><img src="imagens/Icones/alterar.png" alt="" width="48" height="48" border="0" /></a></td>
        <td width="49"><a href="marcas_exc.php?codigo_mar=<?php echo $registro_rsMarcas ['codigo_mar']; ?>"><img src="imagens/Icones/Delete.png" alt="" width="48" height="48" border="0" /></a></td>
        <td width="48"><a href="marcas_det.php?codigo_mar=<?php echo $registro_rsMarcas ['codigo_mar']; ?>"><img src="imagens/Icones/detalhes.png" alt="" width="48" height="48" border="0" /></a></td>
        <td><?php echo $registro_rsMarcas ['nome_mar']; ?></td>
      </tr>
       <?php } while ($registro_rsMarcas = mysql_fetch_assoc ($rsMarcas) ); ?>
    </table>
    <?php } ?>
    <?php if ($total_rsMarcas == 0) { ?>
    <table width="900" border="1">
      <tr>
        <td width="890" align="center"><em>Nenhuma marca cadastrada !</em></td>
      </tr>
    </table>
   <?php } ?>
  </div>
