...
//Leitura
	...
	$principal = $_POST['cdbPrincipal'];
	$quantidade = $_POST['txtQuantidade'];
	$resumo = $_POST['txtResumo'];

	$SQL = "UPDATE tabprodutos SET ".
		   "ativo_pro = '".$ativo."'," .
		   "descricao_pro = '".$descricao. "'," .
		   "imagem_pro = '".$imagem."'," .
		   "codigo_mar = '".$marcas."'," .
		   "codigo_cat = '".$categorias."'," .
		   "preco_unitario_pro = ".$precou."," .
		   "principal_pro = '".$principal."'," .
		   "qtde_estoque_pro = ".$quantidade."," .
		   "resumo_pro = '".$resumo."'" .
  ...
  <div id="divBanner">
    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><em><strong>Confirmação de Alteração de Produtos</strong></em></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    ...
    <form id="form1" name="form1" method="post" action="">
      <table width="100%" border="0" cellpadding="5">
        <tr>
          <td align="center">Alteraçao de Produtos Concluida !</td>
        </tr>
      </table>
    </form>
    <p>&nbsp;</p>
