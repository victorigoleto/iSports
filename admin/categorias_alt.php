    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><strong><em>Alteração de Categorias</em></strong></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    <form id="form1" name="form1" method="post" action="categorias_alt_conf.php">
      <table width="100%" border="0" cellpadding="5">
        <tr>
          <td width="20%"><em><strong>Nome de Categorias:</strong></em></td>
          <td><label for="txtNomeCategorias"></label>
            <input name="txtNomeCategorias" type="text" id="txtNomeCategorias" size="40" value="<?php echo $registro_rsCategorias ['nome_cat']; ?>"/></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td width="50%" align="center"><input type="reset" name="button2" id="button2" value="Limpar" />
            <input type="hidden" name="hidCodigo" id="hidCodigo" value="<?php echo $registro_rsCategorias ['codigo_cat']; ?>"/></td>
        </tr>
      </table>
    </form>
    <p>&nbsp;</p>
