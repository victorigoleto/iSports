    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><strong><em>Inclusão de Marcas</em></strong></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    <form id="form1" name="form1" method="post" action="marcas_inc_conf.php">
      <table width="100%" border="0" cellpadding="5">
        <tr>
          <td width="20%"><strong><em>Nome de Marcas:</em></strong></td>
          <td><label for="txtMarcas"></label>
          <input name="txtMarcas" type="text" id="txtMarcas" size="40" /></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
