...
$nome_cat = $_POST['txtNomeCategorias'];

	$SQL = "UPDATE tabcategorias SET ".
		   "nome_cat ='" .$nome_cat."'" .
  ...
  <div id="divBanner">
    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><em><strong>Confirmação de Alteração de Categorias</strong></em></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    ...
    <form id="form1" name="form1" method="post" action="">
      <table width="100%" border="0" cellpadding="5">
        <tr>
          <td align="center">Alteração de categoria concluida!</td>
        </tr>
      </table>
    </form>
    <p>&nbsp;</p>
