...
<?php
	//Leitura de Dados
	$nome = $_POST['txtNomeClientes'];
	$ativo = $_POST['txtAtivoClientes'];
	$bairro = $_POST['txtBairroClientes'];
	$celular = $_POST['txtCelularClientes'];
	$cep = $_POST['txtCepClientes'];
	$cidade = $_POST['txtCidadeClientes'];
	$cpf = $_POST['txtCpfClientes'];
	$email = $_POST['txtEmailClientes'];
	$endereco = $_POST['txtEnderecoClientes'];
	$estado = $_POST['txtEstadoClientes'];
	$observacoes = $_POST['txtObservacoesClientes'];
	$rg = $_POST['txtRgClientes'];
	$senha = $_POST['txtSenhaClientes'];
	$telefone = $_POST['txtTelefoneClientes'];
	
	
	
	//Criação da Instrução SQL
	$sql = "INSERT INTO tabclientes ".
		"(nome_cli, ativo_cli, bairro_cli,celular_cli, cep_cli, cidade_cli, cpf_cli, email_cli, endereco_cli, estado_cli, observacoes_cli, rg_cli, senha_cli, telefone_cli)".
		"VALUES (".
		" ' " . $nome. " ', ".
		" ' " . $ativo. " ', ".
		" ' " . $bairro. " ', ".
...
<div id="divFundo">
  ...
  <div id="divBanner">
    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><strong><em>Confirmação de Inclusão de Clientes</em></strong></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    <table width="900" border="1">
      <tr>
        <td width="889" align="center"><em>Cliente incluído com sucesso !</em></td>
      </tr>
    </table>
    <p>&nbsp;</p>
  </div>
