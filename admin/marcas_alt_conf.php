...
$nome_mar = $_POST['txtNomeMarcas'];

	$SQL = "UPDATE tabmarcas SET ".
		   "nome_mar = '". $nome_mar . "'" .
  ...
  <div id="divBanner">
    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><em><strong>Confirmação de Alteração de Marcas</strong></em></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    ...
    <form id="form1" name="form1" method="post" action="">
      <table width="100%" border="0" cellpadding="5">
        <tr>
          <td align="center">Alteração de marcas concluida!</td>
        </tr>
      </table>
    </form>
    <p>&nbsp;</p>
