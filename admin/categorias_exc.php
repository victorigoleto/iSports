...
<div id="divFundo">
  ...
  <div id="divBanner">
    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><em><strong>Exclusão de Categorias</strong></em></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    ...
    <table width="900" border="1">
      <tr>
        <td width="890" align="center"><em>Categoria excluída com sucesso !</em></td>
      </tr>
    </table>
    <p>&nbsp;</p>
  </div>
