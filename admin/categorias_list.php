    ...
    <div id="divTitulo1">
      <table width="90%" border="1" align="center" cellspacing="2">
        <tr>
          ...
          <td width="672"><em><strong>Categorias</strong></em></td>
    ...
    <div id="divTitulo2">
      <table width="90%" border="1" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><em><strong>Listagem de Categorias</strong></em></td>
        </tr>
      </table>
    </div>
<p>
      <?php if($total_rsCategorias > 0) { ?></p>
    <table width="900" border="1">
      <tr>
        <td colspan="3">&nbsp;</td>
        <td width="801" align="center"><strong><em>Listagem de Categoria</em></strong></td>
        <?php do { //inicio do Repate Region ?>
      </tr>
     
      <tr>
        <td width="35"><a href="categorias_alt.php?codigo_cat=<?php echo $registro_rsCategorias ['codigo_cat']; ?>"><img src="imagens/Icones/alterar.png" alt="" width="48" height="48" border="0" /></a></td>
        <td width="49"><a href="categorias_exc.php?codigo_cat=<?php echo $registro_rsCategorias ['codigo_cat']; ?>"><img src="imagens/Icones/Delete.png" alt="" width="48" height="48" border="0" /></a></td>
        <td width="48"><a href="categorias_det.php?codigo_cat=<?php echo $registro_rsCategorias ['codigo_cat']; ?>"><img src="imagens/Icones/detalhes.png" alt="" width="48" height="48" border="0" /></a></td>
        <td><?php echo $registro_rsCategorias ['nome_cat']; ?></td>
      </tr>
      <?php } while ($registro_rsCategorias = mysql_fetch_assoc ($rsCategorias) ); ?>
    </table>
    <?php } ?>
    <?php if ($total_rsCategorias == 0) { ?>
    <table width="900" border="1">
      <tr>
        <td width="890" align="center"><em>Nenhuma categoria cadastrado !</em></td>
      </tr>
    </table>
   <?php } ?>
  </div>
