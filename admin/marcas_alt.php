    ...
    <div id="divTitulo1">
      <table width="90%" border="0" align="center" cellspacing="2">
        <tr>
          ...
          <td width="672"><strong><em>Marcas</em></strong></td>
    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753"><strong><em>Alteração de Marcas</em></strong></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    <form id="form1" name="form1" method="post" action="marcas_alt_conf.php">
      <table width="100%" border="0" cellpadding="5">
        <tr>
          <td width="20%"><em><strong>Nome de Marcas:</strong></em></td>
          <td><label for="txtNomeMarcas"></label>
          <input name="txtNomeMarcas" type="text" id="txtNomeMarcas" size="40" value="<?php echo $registro_rsMarcas ['nome_mar']; ?>"/></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td width="50%" align="center"><input type="reset" name="button2" id="button2" value="Limpar" />
            <input type="hidden" name="hidCodigo" id="hidCodigo" value="<?php echo $registro_rsMarcas ['codigo_mar']; ?>"/></td>
        </tr>
      </table>
    </form>
    <p>&nbsp;</p>
