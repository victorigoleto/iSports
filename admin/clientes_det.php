...
<div id="divFundo">
  ...
  <div id="divBanner">
    ...
    <div id="divTitulo2">
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          ...
          <td width="753">Detalhes do Cliente</td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
    <table width="100%" border="1" cellpadding="5">
      <tr>
        <td width="20%"><strong><em>Nome do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['nome_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Celular do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['celular_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Telefone do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['telefone_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Bairro do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['bairro_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Endereço do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['endereco_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Cidade do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['cidade_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Estado do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['estado_cli']; ?></td>
      </tr>
      <tr>
        <td><em><strong>Cep do Cliente:</strong></em></td>
        <td><?php echo $registro_rsClientes['cep_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Cpf do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['cpf_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Rg do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['rg_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Email do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['email_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Observações do Cliente:</em></strong></td>
        <td><label for="txtObservacoesClientes"><?php echo $registro_rsClientes['observacoes_cli']; ?></label></td>
      </tr>
      <tr>
        <td><strong><em>Ativo Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['ativo_cli']; ?></td>
      </tr>
      <tr>
        <td><strong><em>Senha do Cliente:</em></strong></td>
        <td><?php echo $registro_rsClientes['senha_cli']; ?></td>
      </tr>
    </table>
    <p>&nbsp;</p>
  </div>
